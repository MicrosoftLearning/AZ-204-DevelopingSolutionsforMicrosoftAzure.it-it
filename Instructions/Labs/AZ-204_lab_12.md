...
1. **Nella scheda Impostazioni** applicazione selezionare l'impostazione dell'applicazione rete CDN MediaEndpoint** esistente**.

1. **Nella finestra di dialogo popup Aggiungi/Modifica impostazione** applicazione aggiornare la **casella di testo Valore** immettendo l'URL **del nome** host endpoint dall'endpoint **cdnmedia**_[nomeutente]_ copiato in precedenza nel lab e quindi selezionare **Applica**.

1. Selezionare l'impostazione dell'applicazione **CDNVideoEndpoint** esistente.

1. **Nella finestra di dialogo popup Aggiungi/Modifica impostazione** applicazione aggiornare la **casella di testo Valore** immettendo l'URL **del nome** host endpoint dall'endpoint **cdnvideo**_[nomeutente]_ copiato in precedenza nel lab e quindi selezionare **Applica**.
