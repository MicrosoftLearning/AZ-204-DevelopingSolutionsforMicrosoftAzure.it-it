...
1. **Nel pannello Application Insights**, nella **scheda Informazioni di base**, eseguire le azioni seguenti e selezionare **Rivedi e crea**:
...
![Selezione dell'opzione corretta per il metodo scale out](./media/l11_scale_web_app_choose_rules.png)
