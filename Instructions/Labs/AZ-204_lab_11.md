...
1.  Nel pannello **Servizio app** selezionare **Application Insights** e quindi **Attiva Application Insights**.
...
1.  Registrare l'URL usato per accedere all'output in formato JSON.
    ...
    > **Nota**: il formato dell'URL deve essere `https://smpapianu.azurewebsites.net/weatherforecast`.
