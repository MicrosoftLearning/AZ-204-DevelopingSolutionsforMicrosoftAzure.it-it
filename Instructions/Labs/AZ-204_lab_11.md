...
1. Scorrere verso il basso fino a visualizzare il **Metodo aumento delle istanze**. Fare clic sull'opzione **Basata su regole** e quindi selezionare **Gestisci scalabilità basata su regole**.
