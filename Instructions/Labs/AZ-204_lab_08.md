...
1.  All'interno dell'applicazione Web eseguire le azioni seguenti:
    ...
    Questa barra delle applicazioni contiene le icone delle applicazioni che verranno usate in questo lab:
...
1.  Nella finestra **Crea un'API HTTP** eseguire le azioni seguenti e selezionare **Crea**:
    ...
    | Casella di testo **URL servizio Web** | Enter the URL for the web app that you copied earlier in this lab. <bpt id="p1">**</bpt>Note<ept id="p1">**</ept>: Make sure that the URL starts with the https:// prefix |
...
1.  Nella sezione **Riscrivi URL** eseguire le azioni seguenti:
    ...
    **Nota**: se si sta eseguendo l'accesso al portale di Azure per la prima volta, verrà visualizzata una presentazione del portale.
