...
1.  All'interno dell'applicazione Web eseguire le azioni seguenti:
    ...
    1.  Selezionare **Formati di risposta**.

    1.  Selezionare **GET /html**.

    1.  Selezionare **Prova**.

    1.  Selezionare **Esegui**.

    1.  Esaminare il valore delle caselle di testo **Corpo della risposta** e **Intestazioni della risposta**.

    1.  Esaminare il valore della casella di testo **URL della richiesta**.

1.  All'interno dell'applicazione Web eseguire le azioni seguenti:

    1.  Selezionare **Dati dinamici**.

    1.  Selezionare **GET /bytes/{n}** .

    1.  Selezionare **Prova**.

    1.  Nella casella di testo **n** immettere **25**.

    1.  Selezionare **Esegui**.

    1.  Esaminare il valore delle caselle di testo **Corpo della risposta** e **Intestazioni della risposta**.

    1.  Selezionare **Scarica il file**. Al termine del download, aprire il file in Blocco note, esaminarne il contenuto e quindi chiuderlo.
...
1.  All'interno dell'applicazione Web eseguire le azioni seguenti:
    ...
    1.  Selezionare **Codici di stato**.

    1.  Selezionare **GET /status/{codes}** .

    1.  Selezionare **Prova**.

    1.  Nella casella di testo **codici** immettere **404**.

    1.  Selezionare **Esegui**.

    1.  Esaminare la sezione **Server response** (Risposta del server) e notare che include la voce **Error: NOT FOUND** (Errore: NON TROVATO).
...
1.  Nella sottosezione **Parametri del modello** della sezione **Generate Payload** immettere **512** nella casella di testo **VALUE** del parametro **n** e quindi selezionare **Invia**.
...
1.  Nella sottosezione **Parametri del modello** della sezione **Generate Payload** immettere **512** nella casella di testo **VALUE** del parametro **n**, quindi selezionare **Invia**.
