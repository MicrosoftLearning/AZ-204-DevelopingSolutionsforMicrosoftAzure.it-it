...
1. Passare all'applicazione **Terminale Windows**.
...
1. **Nel riquadro Cloud Shell** selezionare il pulsante di caricamento/download (rappresentato da una pagina piegata con due frecce che puntano nelle direzioni opposte nell'angolo inferiore destro) e, nel menu a discesa, selezionare **Carica**.

1. **Nella finestra di dialogo Apri** passare alla **directory vuota Allfiles (F):\\Allfiles\\Labs\\05\\Starter\\func** vuota, selezionare **lab05.zip** e quindi selezionare **Apri**.

    > **Nota**: il file verrà aggiornato nella ****/~directory all'interno della **sessione di Cloud Shell.**
