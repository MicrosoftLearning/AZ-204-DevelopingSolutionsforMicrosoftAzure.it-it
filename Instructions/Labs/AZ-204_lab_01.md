...
1. Nella **sezione Variabili** di ambiente eseguire le azioni seguenti, selezionare **Applica** e quindi selezionare **Continua**:
    ...
    | Fare clic su **Applica** nel menu in alto | In questo modo verrà salvato il valore di configurazione appena immesso |
