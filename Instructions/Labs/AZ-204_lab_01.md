...
> **Sottoscrizioni attive**: se sono presenti più sottoscrizioni attive. È sempre possibile specificare quale sottoscrizione usare il parametro di sottoscrizione nel comando. Per altre informazioni sulla gestione della sottoscrizione, vedere l'interfaccia della riga di [comando](https://docs.microsoft.com/en-us/powershell/azure/azurerm/manage-subscriptions-azureps?view=azurermps-6.13.0) di [Azure](https://docs.microsoft.com/en-us/cli/azure/manage-azure-subscriptions-azure-cli), Azure PowerShell
...
1. Nella scheda **Dati principali** del pannello **Crea app Web** eseguire le azioni seguenti e selezionare **Avanti: Distribuzione**:
    ...
    | Sezione **SKU e dimensioni**           | Mantenere il valore predefinito. (Per ottimizzare il costo per questo esercizio, è consigliabile usare **SKU - Standard S1**)                                    |
...
1. Nella scheda **Distribuzione** selezionare **Avanti** due volte per passare a **Monitoraggio**.
