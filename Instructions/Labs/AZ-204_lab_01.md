...
1.  **Nel pannello Chiavi** di accesso esaminare una delle chiavi (usando **il pulsante Mostra**) e quindi copiare il valore di una delle ** caselle di stringa** Connessione ion negli Appunti.
...
1. Nella finestra **Nuovo contenitore** eseguire le azioni seguenti:
   ...
   | Elenco **Livello di accesso pubblico** | Selezionare **Privato (nessun accesso anonimo)** e quindi selezionare **Crea** |
...
1. Nella scheda **Informazioni di base** del pannello **Crea app Web** eseguire le azioni seguenti e selezionare la scheda **Monitoraggio**:
   ...
   | Elenco a discesa **Stack di runtime**   | Selezionare **.NET 8 (anteprima LTS)**                                                                                 |
...
1. Immettere il comando seguente e quindi premere INVIO per distribuire il file **api.zip** nell'app Web creata in precedenza in questo lab:
   ...
   > **Nota**: sostituire il segnaposto _\<name-of-your-api-app\>_ con il nome dell'app Web creata in precedenza in questo lab. Di recente, nei passaggi precedenti, è stata eseguita una query sul nome dell'app.
...
1. Nella scheda **Informazioni di base** del pannello **Crea app Web** eseguire le azioni seguenti e selezionare la scheda **Monitoraggio**:
   ...
   | Sezione **Pubblica**                | Selezionare **Codice**               |
   | Elenco a discesa **Stack di runtime**   | Selezionare **.NET 8 (LTS) (anteprima)**       |
   | Sezione **Sistema operativo**       | selezionare **Windows**            |
   | Elenco a discesa **Area**          | Selezionare l'area **Stati Uniti orientali** |
...
1. Immettere il comando seguente e quindi premere INVIO per distribuire il file **web.zip** nell'app Web creata in precedenza in questo lab:
   ...
   > **Nota**: sostituire il segnaposto _\<name-of-your-web-app\>_ con il nome dell'app Web creata in precedenza in questo lab. Di recente, nei passaggi precedenti, è stata eseguita una query sul nome dell'app.
