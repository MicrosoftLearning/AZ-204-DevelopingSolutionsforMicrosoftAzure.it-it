...
1. Nella finestra **Nuovo contenitore** eseguire le azioni seguenti:
   ...
   | **Elenco a livello** di accesso anonimo | Lasciare **privato (nessun accesso anonimo)** e quindi selezionare **Crea** |
...
1. Nella sezione **Configurazione** eseguire le azioni seguenti, selezionare **Salva** e quindi selezionare **Continua**.
   ...
   | Casella di controllo **Impostazione slot di distribuzione**          | Mantenere il valore predefinito e quindi selezionare **OK** per chiudere la finestra di dialogo popup e tornare alla sezione **Configurazione** |
      | Selezionare **Salva** nel menu in alto           | In questo modo verrà salvato il valore di configurazione appena immesso |
...
1. Nella pagina Web **Contoso Photo Gallery**, nella sezione **Upload a new image** (Carica una nuova immagine) eseguire le azioni seguenti:
   ...
   b. **Nella finestra Esplora file** passare a **Allfiles (F):\\Allfiles\\Labs\\01\\Starter Images** (Immagini iniziali\\), selezionare il **file banhmi.jpg** e quindi selezionare **Apri**.
