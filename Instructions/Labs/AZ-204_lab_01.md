...
> **Sottoscrizioni attive**: se sono disponibili più sottoscrizioni attive. È sempre possibile specificare quale sottoscrizione usare tramite il parametro subscription nel comando. Vedere qui per altre informazioni su come gestire le sottoscrizioni con l'[interfaccia della riga di comando di Azure](https://docs.microsoft.com/en-us/cli/azure/manage-azure-subscriptions-azure-cli) o [Azure PowerShell](https://docs.microsoft.com/en-us/powershell/azure/azurerm/manage-subscriptions-azureps?view=azurermps-6.13.0)
