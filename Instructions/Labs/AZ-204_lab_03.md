...
1. Nel pannello **Chiavi** di accesso selezionare **Mostra** per una delle caselle di **testo Chiave** . Non importa quale usi, sono intermutabili.

1. Esaminare una delle chiavi e quindi copiare il valore di una delle **caselle Chiave** negli Appunti e incollarlo in Blocco note.
...
1. Nel terminale eseguire il comando seguente per importare la versione 12.18.0 di **Azure.Archiviazione. ** BLOB da NuGet:
