...
1. Copiare l'indirizzo IP pubblico del contenitore e incollarlo nel Web browser con il numero di porta e quindi premere enther.
...
In questo esercizio si apprenderà come creare un'app contenitore usando l'immagine del contenitore creata nell'exersice 1.
...
1. Nella **scheda Contenitore** compilare le informazioni seguenti e quindi selezionare **Avanti: Ingresso**:
    ...
    | **Elenco a discesa CPU e memoria** | Selezionare **0,25 core CPU, 0,5 Gi memorizzare** nell'elenco |
...
1. Nella **scheda Ingresso** compilare le informazioni seguenti:
    ...
    | **Casella di traffico** in ingresso | Selezionare **Limitato all'ambiente app contenitore** |
    ...
    | **Casella di testo Porta**  di destinazione | Immettere **80** |
