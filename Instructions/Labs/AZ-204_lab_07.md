...
In questo lab si creeranno un account di archiviazione e un'app per le funzioni di Azure che accederà all'account di archiviazione. Per illustrare l'archiviazione sicura delle informazioni sulla stringa di connessione, si eseguirà il provisioning di una risorsa di Key Vault e si gestiranno i segreti appropriati per archiviare le informazioni sulla stringa di connessione. Si gestirà anche l'identità del servizio per ottenere l'accesso sicuro alle informazioni sulla stringa di connessione per l'account di archiviazione.
...
1. Nella scheda **Informazioni di base** del pannello **Crea app per le funzioni** eseguire le azioni seguenti e selezionare **Avanti: Archiviazione**:
