...
1. Nel pannello **Creare un criterio di accesso** selezionare la sezione **1 Autorizzazioni** ed effettuare le selezioni seguenti:
...
1. Selezionare la sezione **2 Entità di sicurezza** ed effettuare le selezioni seguenti: 
...
1. Selezionare **4 Rivedi e crea** e selezionare **Crea**.
