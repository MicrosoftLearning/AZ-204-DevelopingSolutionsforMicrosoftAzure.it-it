...
1. Esaminare il codice risultante, che deve essere costituito dal contenuto seguente (questo codice restituisce il valore della variabile di ambiente ArchiviazioneConnessione ionString):
...
1. Sostituire il contenuto del codice generato automaticamente della funzione **FileParser** a partire dalla riga 19 con il codice seguente:
...
1. Esaminare il codice risultante, che deve essere costituito dal contenuto seguente (questo codice restituisce il contenuto del BLOB scaricato dall'account di archiviazione designato dalla variabile di ambiente ArchiviazioneConnessione ionString):
