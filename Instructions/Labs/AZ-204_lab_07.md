...
1. Nel pannello **Aggiungi criterio di accesso** eseguire le azioni seguenti e selezionare **Aggiungi**:
    ...
    | Elenco a discesa **Autorizzazioni delle chiavi** | 0 selezionato |
    | Elenco a discesa **Autorizzazioni dei segreti** | Selezionare l'autorizzazione **GET** |
    | Elenco a discesa **Autorizzazioni del certificato** | 0 selezionato |
    | Collegamento **Selezionare un'entità** | Poiché gli aggiornamenti cloud vengono apportati spesso, tuttavia, è possibile che si rilevino modifiche all'interfaccia utente prima degli aggiornamenti del contenuto per la formazione. |
...
1. La barra delle applicazioni include le icone per le applicazioni che verranno usate nel lab, tra cui:
