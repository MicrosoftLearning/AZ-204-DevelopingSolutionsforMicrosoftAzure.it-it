...
#### <a name="task-3-register-azure-storage-blob-extensions"></a>Attività 3: Registrare le estensioni BLOB del servizio di archiviazione di Azure
...
1. #### <a name="task-4-write-http-triggered-and-blob-inputted-function-code"></a>Attività 4: Scrivere il codice della funzione attivato da HTTP e con input BLOB
