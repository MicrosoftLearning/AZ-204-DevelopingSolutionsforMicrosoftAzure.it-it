...
In questo esercizio è stato creato uno spazio dei nomi di Azure **bus di servizio e una **coda di bus di servizio** che verrà usata nel** resto del lab.
...
1. Aggiungere il codice seguente:
    ...
    ```
    > **Nota**: aggiornare la **costante della stringa serviceBus Connessione ionString** impostando il relativo valore su **Primary Connessione ion String** dello spazio dei nomi bus di servizio e verificare che la **costante queueName** sia impostata su **messagequeue**, corrispondente al nome della coda bus di servizio creata in precedenza in questo Esercizio
...
1. Selezionare **bus di servizio Explorer**.

1. Con l'intestazione **della scheda Visualizza** modalità di visualizzazione selezionata, nella **scheda Coda** selezionare il pulsante Visualizza dall'avvio****.
