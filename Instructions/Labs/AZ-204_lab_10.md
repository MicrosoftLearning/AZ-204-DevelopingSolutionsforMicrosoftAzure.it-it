...
1.  Nel metodo **Main** aggiungere il codice seguente per creare un oggetto **ServiceBusMessageBatch** che consentirà di combinare più messaggi in un batch usando il metodo **TryAdMessage**:
