...
È tutto! Con questi passaggi, è necessario essere in grado di configurare l'autenticazione per l'applicazione Web di Azure e assicurarsi che solo gli utenti autorizzati siano in grado di accedervi.
...
È tutto! Con questi passaggi, è necessario essere in grado di configurare i log di accesso per il servizio Web di Azure e assicurarsi che l'applicazione sia sicura e conforme ai criteri dell'organizzazione.
...
È tutto! Application Insights è stato configurato correttamente ed è stato eseguito l'accesso alla mappa delle applicazioni per l'app Web di Azure.
...
È tutto! La funzionalità disponibilità in Application Insights per l'app Web in Azure è stata configurata correttamente.
